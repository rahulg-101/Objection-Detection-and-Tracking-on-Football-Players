...
from YOLO_Object_Detection_and_Tracking.constant.training_pipeline import *
...
class DataValidationConfig:
    data_validation_dir = os.path.join(TrainingPipelineConfig.artifacts_dir,
...
class ModelTrainerConfig:
    model_trainer_dir = os.path.join(TrainingPipelineConfig.artifacts_dir,
    ...
    imgsz = MODEL_TRAINER_IMAGE_SIZE                        
